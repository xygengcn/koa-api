...
// 返回类型提示
export function ReturnsDecorator(options: { [key: string]: DefaultMethodValue }) {
...
// 请求头校验
export function HeadersDecorator(options: { [key: string]: DefaultMethodValue }) {
    return DecoratorMethodExtends('headers', options);
}

// 参数检验
export function ContentDecorator(options: { [key: string]: DefaultMethodValue }) {
    return DecoratorMethodExtends('content', options);
}

// 参数检验
export function QueryDecorator(options: { [key: string]: DefaultMethodValue }) {
    return DecoratorMethodExtends('query', options);
}

// exts参数校验
export function ExtsDecorator(options: { [key: string]: DefaultMethodValue }) {
    return DecoratorMethodExtends('exts', options);
}

// auth校验
export function AuthDecorator(options: RequestOptions['auth']) {
    return DecoratorMethodExtends('auth', options);
}
